"""
    ...
    Fichier : algos.py, contient les algorithmes principaux utilisés dans le code
...
if __name__ == "__main__":
    print("Ce fichier ne peut pas être exécuté directement, éxécutez le fichier main.py")